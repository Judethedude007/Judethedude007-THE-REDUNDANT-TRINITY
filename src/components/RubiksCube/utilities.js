...
/**Return is new position based on current position and resultant rotation */
...
export const getCubePositionDifference = (movedPosition, currentPosition, xMove, yMove) => {
